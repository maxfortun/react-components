...
export default function Resizable2Panels(props) {
	...
	const [ mode, setMode ] = useLocalStorageState((props.id+'M'||'m') + 'ode', 'custom');

	const [ customWidth, setCustomWidth ] = useLocalStorageState((props.id+'C'||'c') + 'ustomWidth', defaultWidth);
